...
public:
    ...
    bool Init()
    {
        ...
        m_pEffect->SetColor(0, Vector4f(1.0f, 0.5f, 0.7f, 0.0f));
        m_pEffect->SetColor(1, Vector4f(1.0f, 1.0f, 1.0f, 0.0f));
        m_pEffect->SetColor(2, Vector4f(1.0f, 0.3f, 0.3f, 0.0f));
        m_pEffect->SetColor(3, Vector4f(0.4f, 0.0f, 1.0f, 0.0f));
...
int main(int argc, char** argv)
{
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, 32, false, "Lesson 33 :33")) {
        return 1;
    }
